...
public class Update_Details_Data  extends JFrame implements ActionListener{
    ...
    Update_Details_Data(){
        ...
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("Employee_management/icon/home.png"));
        Image img1=img.getImage().getScaledInstance(400, 700,Image.SCALE_DEFAULT);

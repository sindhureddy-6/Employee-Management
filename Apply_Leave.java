...
public class Apply_Leave extends JFrame implements ActionListener{
    ...
    Apply_Leave(){
        ...
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("Employee_management/icon/6.png"));
    ...
    public void actionPerformed(ActionEvent ev) {
        if(ev.getSource()==bt1){
            ...
            String Startdate=tf3.getText();
            String enddate=tf4.getText();
            ...
            try{
                ...
                ConnectionClass obj2=new ConnectionClass();
                String q2="insert into apply_leave values('"+eid+"','"+name+"','"+email+"','"+Startdate+"','"+enddate+"','"+apply_date+"','"+reason+"')";
                int aa=obj2.stm.executeUpdate(q2);
                if(aa==1){
                    JOptionPane.showMessageDialog(null,"Your data succesfully updated");

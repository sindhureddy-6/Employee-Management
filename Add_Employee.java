...
public class Add_Employee extends JFrame implements ActionListener {
    ...
    Add_Employee(){
      ...
      id2=new JLabel("Name");
      id2.setBounds(50,150, 80, 30);
      id2.setFont(new Font("Airal",Font.BOLD,20));
    // id2.setBorder(BorderFactory.createLineBorder(Color.BLACK));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==b){
          try{
            ...
            String q="insert into employee values('"+name+"','"+fname+"','"+age+"','"+dob+"','"+address+"','"+phone+"','"+email+"','"+education+"','"+pos+"','"+aadhar+"','"+eid+"')";
